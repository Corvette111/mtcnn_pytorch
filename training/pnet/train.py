...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(
        FaceDataset(config.annoPath, prefix_path=config.dataPath, transform=transform, is_train=True), batch_size=config.batchSize, shuffle=True, **kwargs)
    ...
    trainer = PNetTrainer(config.lr, train_loader, model, optimizer, scheduler, None, device)
